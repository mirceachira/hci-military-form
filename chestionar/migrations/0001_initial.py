...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='FillInQuestion',
            fields=[
                ('question_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='chestionar.question')),
        ...
        migrations.AddField(
            model_name='question',
            name='page',
            field=models.ForeignKey(help_text='Pagina pe care apare aceasta intrebare', on_delete=django.db.models.deletion.CASCADE, to='chestionar.questionpage'),
        ),
    ]
